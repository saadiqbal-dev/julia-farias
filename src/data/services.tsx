...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    supportingText: (
      <>
        <p>
          Os alinhadores, popularmente conhecidos como "aparelhos invisíveis",
          são a mais moderna evolução no tratamento para corrigir a posição dos
          dentes.
        </p>
        <p>
  ...
  },
  {
    ...
    supportingText: (
      <>
        <p>
          São finíssimas lâminas de cerâmica, desenhadas digitalmente e
          produzidas em um laboratório especializado. Cada peça é fixada de
          forma permanente sobre os dentes para criar uma transformação de
          altíssima precisão e naturalidade.
        </p>
        <p>
          É a escolha ideal para quem busca o mais alto padrão estético.
          Perfeitas para corrigir alterações severas de cor, dentes desgastados
          ou para criar um sorriso totalmente novo, com uma cor que não muda com
          o tempo e uma durabilidade incomparável.
        </p>
        <p>
          Ficou com alguma dúvida? Estamos à disposição para conversar e
          esclarecer todos os pontos, sem compromisso.
    ...
    supportingText: (
      <>
        <p>
          ...
          partículas e pigmentos que deixam os dentes amarelados. Realizado
          sempre com a supervisão de um dentista, ele pode ser feito no
          consultório, em casa com moldeiras, ou combinando as duas técnicas.
        </p>
        <p>
          É a maneira mais simples e conservadora de recuperar a cor original do
          seu sorriso, ideal para quem se incomoda com manchas de café, chás e
          outros alimentos. O resultado é um sorriso visivelmente mais claro,
          iluminado e que renova a autoconfiança.
        </p>
        <p>
    ...
    supportingText: (
      <>
        <p>
          ...
          instalado um dente de porcelana, com aparência e função idênticas às
          de um dente natural.
        </p>
        <p>
